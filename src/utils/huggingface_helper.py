...
def download_repository(repository_id: str = "lysandre/arxiv-nlp",
    ...
    local_folder = snapshot_download(repo_id=repository_id, ignore_patterns=ignore_regex)
    print(f"{repository_id} downloaded in {local_folder}")


if __name__ == '__main__':
    # download_repository(repository_id="mse30/bart-base-finetuned-pubmed")
    download_repository(repository_id="theojolliffe/bart-large-cnn-finetuned-pubmed")
