...
EXPERIMENT_GROUP = "summarisation"

MODEL_NAME = "cg_bart"
# MODEL_NAME = "sumref_pegasus"
# MODEL_NAME = "sumbart"

MODEL_NAME_OR_PATH = f'facebook/bart-base'
# MODEL_NAME_OR_PATH = f'google/pegasus-pubmed'
...
def add_customized_args(parser: argparse.ArgumentParser = None):
    ...
    parser.add_argument("--abstract_max_len", default=256, type=int, help="max input length")
    parser.add_argument("--doc_max_len", default=766, type=int, help="max abstract length")
    parser.add_argument(
        "--max_target_length",
        default=1024,
        type=int,
    ...
    parser.add_argument("--max_neighbor_num", default=12, type=int, help="max neighbor number")
    ...
    parser.add_argument("--eval_beams", type=int, default=0, required=False)
    ...
    parser.add_argument("--use_r_drop", type=str2bool, default=False)
    parser.add_argument(
